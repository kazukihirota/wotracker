...
def create_app():
    ...
    # Session config
    app.secret_key = 'thisismysecretkeydonotstealit'
    app.config['SESSION_COOKIE_NAME'] = 'google-login-session'
    app.config['PERMANENT_SESSION_LIFETIME'] = timedelta(days=50)

    #database 
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://zvepibcuvpddjz:db47a8d47c276945a160581d60ee7c7ce7435fceec3e2e842250fa1abbcec395@ec2-52-200-48-116.compute-1.amazonaws.com:5432/da858j6qum99tv'
    #initialise database
    db.init_app(app)
